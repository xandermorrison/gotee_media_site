...
//Application Title
define('APP_TITLE', 'Gotee Records Media');
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://gotee.com" target="_blank" class="float-right text-muted">Gotee Records <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://gotee.com" target="_blank" class="float-right text-muted">Gotee Records <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
...
<a class="navbar-brand" href=""><img style="max-height: 40px" src="logo.png"></a>
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Gotee Records';      $tr['en']['AppTitle']           = 'Gotee Records';
